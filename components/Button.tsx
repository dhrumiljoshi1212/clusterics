...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-energy-500 hover:bg-energy-600 text-white focus:ring-energy-500 shadow-md shadow-energy-500/20",
    secondary: "bg-white hover:bg-slate-50 text-slate-700 border border-slate-300 focus:ring-slate-500 shadow-sm",
